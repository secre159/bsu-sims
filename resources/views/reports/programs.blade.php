<x-app-layout>
    <x-slot name="title">Programs Report</x-slot>
    <x-slot name="header">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="mb-4 flex justify-between items-center">
                        ...
                        <a href="{{ route('reports.programs.pdf') }}" class="inline-flex items-center bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded">
